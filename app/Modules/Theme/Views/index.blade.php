...
@section('content')
	        ...
	        <div class="col-xs-12">
	          <div class="box box-success">
	            <div class="box-header">
		            ...
		            <div class="box-tools">
		                <a href="{{ url('panel/themes/create') }}" class="btn btn-block btn-success">
	            ...
	            <div class="box-body table-responsive">
		                		...
		                		<tr>
		                			<td>
				                  		<div class="user-block">
						                    <img class="img-circle img-bordered-sm" src="{{ url('uploads/photos/thumb').'/'.$theme->image }}" alt="{{ $theme->name }}">
						                </div>
				                  	</td>
				                  	<td>{{ $theme->name }}</td>
				                  	<td>{{ $theme->folder }}</td>
				                  	...
				                  	<td>
				                  		<div class="btn-group">
					                      	{{ Form::open(array('url' => 'panel/themes/'.$theme->id)) }}
							                    {{ Form::hidden('_method', 'DELETE') }}
							                    <!-- <a href="{{ url('panel/themes/'.$theme->id) }}" class="btn btn-default"><i class="fa fa-eye"></i></a> -->
					                      		<a href="{{ url('panel/themes/'.$theme->id.'/edit') }}" class="btn btn-default"><i class="fa fa-pencil"></i></a>
	              	...
	              	<div class="pagination pull-right">
                        {{ $themes->appends($_REQUEST)->render() }}
                    </div>
    ...
    <script type="text/javascript">
    	$(document).ready(function () {
        	...
        	page_select('themes-manage', 'themes', 'Themes', 'Manage');
		});
    </script>
