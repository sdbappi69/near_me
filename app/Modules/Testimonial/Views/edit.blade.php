...
@section('content')
    	...
    	<div class="row">
	        <div class="col-xs-12 animated bounceInDown">
	    		<div class="box box-success">
		            ...
		            <!-- /.box-header -->
		            <!-- form start -->
		            {!! Form::model($testimonial, array('url' => 'panel/testimonials/'.$testimonial->id, 'method' => 'put', 'enctype' => 'multipart/form-data')) !!}
		              	...
		              	<div class="box-footer">
		              		<a href="{{ url('panel/testimonials') }}" class="btn btn-default">Cancel</a>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function () {
        	...
        	page_select('testimonials-manage', 'testimonials', 'Testimonials', 'update');
		});
