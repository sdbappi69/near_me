...
@section('content')
    	...
    	<div class="row">
	        <div class="col-xs-12 animated bounceInDown">
	    		<div class="box box-success">
		            ...
		            <!-- /.box-header -->
		            <!-- form start -->
		            {{ Form::open(array('url' => 'panel/tearsheets', 'enctype' => 'multipart/form-data')) }}
							...
							@include('partials.errors')
		              		...
		              		<div class="col-md-6">
			            		...
			            		<div class="form-group">
			            			...
			            			{!! Form::select('category_id', ['' => 'Select category']+$categories, $default_category_id, ['class' => 'form-control js-example-basic-single input-lg', 'id' => 'category_id', 'required' => 'required']) !!}
			            		</div>
			            		<div class="form-group">
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function () {
        	...
        	page_select('tearsheets-add', 'tearsheets', 'Tearsheet', 'Add');
		});
