...
@section('content')
    	...
    	<div class="row">
	        <div class="col-xs-12 animated bounceInDown">
	    		<div class="box box-success">
		            ...
		            <!-- /.box-header -->
		            <!-- form start -->
		            {!! Form::model($tearsheet, array('url' => 'panel/tearsheets/'.$tearsheet->id, 'method' => 'put', 'enctype' => 'multipart/form-data')) !!}
		              	...
		              	<div class="box-footer">
		              		<a href="{{ url('panel/tearsheets') }}" class="btn btn-default">Cancel</a>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function () {
        	...
        	page_select('tearsheets-manage', 'tearsheets', 'Tearsheet', 'update');
		});
