...
@section('content')
	        ...
	        <div class="col-xs-12">
	          <div class="box box-success">
	            <div class="box-header">
		            ...
		            <div class="box-tools">
		                <a href="{{ url('panel/tearsheets/create') }}" class="btn btn-block btn-success">
	            ...
	            <div class="box-body table-responsive">
	              	...
	              	<div class="pagination pull-right">
                        {{ $tearsheets->appends($_REQUEST)->render() }}
                    </div>
    ...
    <script type="text/javascript">
    	$(document).ready(function () {
        	...
        	page_select('tearsheets-manage', 'tearsheets', 'Tearsheet', 'Manage');
		});
    </script>
