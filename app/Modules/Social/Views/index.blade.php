...
@section('content')
	    		...
	    		<div class="box box-info">
		            ...
		            {!! Form::open(array('method' => 'get')) !!}
		              	...
		              	<div class="box-body">
		            		...
		            		<div class="col-md-3">
		            			<?php if (!isset($_GET['url'])) { $_GET['url'] = null; } ?>
		            			<input value="{{ $_GET['url'] }}" class="form-control input-lg" name="url" type="text" placeholder="URL">
		            		</div>
		            		<div class="col-md-3">
	        ...
	        <div class="col-xs-12">
	          <div class="box box-success">
	            <div class="box-header">
		            ...
		            <div class="box-tools">
		                <a href="{{ url('panel/socials/create') }}" class="btn btn-block btn-success">
	            ...
	            <div class="box-body table-responsive">
		                		...
		                		<tr>
		                			<td>
				                  		<div class="user-block">
						                    <img class="img-circle img-bordered-sm" src="{{ url('uploads/photos/full').'/'.$social->image }}" alt="{{ $social->name }}">
						                </div>
				                  	</td>
				                  	<td>{{ $social->name }}</td>
				                  	<td>{{ $social->url }}</td>
	              	...
	              	<div class="pagination pull-right">
                        {{ $socials->appends($_REQUEST)->render() }}
                    </div>
    ...
    <script type="text/javascript">
    	$(document).ready(function () {
        	...
        	page_select('socials-manage', 'socials', 'Social networks', 'Manage');
		});
    </script>
