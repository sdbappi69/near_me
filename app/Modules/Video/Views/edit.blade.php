...
@section('content')
    	...
    	<div class="row">
	        <div class="col-xs-12 animated bounceInDown">
	    		<div class="box box-success">
		            ...
		            <!-- /.box-header -->
		            <!-- form start -->
		            {!! Form::model($video, array('url' => 'panel/videos/'.$video->id, 'method' => 'put', 'enctype' => 'multipart/form-data')) !!}
		              	...
		              	<div class="box-footer">
		              		<a href="{{ url('panel/videos') }}" class="btn btn-default">Cancel</a>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function () {
        	...
        	page_select('videos-manage', 'videos', 'Videos', 'update');
		});
